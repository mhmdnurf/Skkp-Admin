...
const PengajuanSkripsiTable = ({ data, startIndex, handleDelete }) => {
  return (
    <>
      <table className="overflow-x-auto block bg-white rounded-t-lg text-slate-700 drop-shadow-md uppercase">
        <thead className=" shadow-sm font-extralight text-sm">
          <tr className="">
            ...
            <th className="p-2 px-6">Prodi</th>
...
PengajuanSkripsiTable.propTypes = {
  data: PropTypes.array.isRequired,
  startIndex: PropTypes.number.isRequired,
  handleDelete: PropTypes.func.isRequired,
};

export default PengajuanSkripsiTable;
