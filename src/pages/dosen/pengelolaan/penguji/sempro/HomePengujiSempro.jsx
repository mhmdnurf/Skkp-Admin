...
export const HomePengujiSempro = () => {
  ...
  const [nilaiPenguji, setNilaiPenguji] = useState(null);
    ...
    if (user) {
      const unsubscribe = onSnapshot(
        query(
          ...
          where("penguji", "array-contains", user.uid),
          orderBy("status", "asc")
        ),
        async (snapshot) => {
          const fetchedData = [];
          ...
          <div className="flex bg-slate-100 h-screen">
            ...
            <div className="flex flex-col w-full pl-[300px] overflow-y-auto pr-4 pb-4">
              <h1 className="text-2xl text-white text-center shadow-md font-bold rounded-lg p-4 m-4 mb-10 bg-slate-600">
                Nilai Penguji Seminar Proposal
              </h1>
                ...
                <table className="overflow-x-auto block bg-white rounded-t-lg text-slate-700 drop-shadow-md">
                  <thead className=" shadow-sm font-extralight text-sm">
                    <tr className="">
                      ...
                      <th className="p-2 px-6 whitespace-nowrap">Judul</th>
                      <th className="p-2 px-6">Pembimbing</th>
                      <th className="p-2 px-6">Nilai</th>
                    ...
                    {data.slice(startIdx, endIdx).map((item, index) => (
                      ...
                      >
                        ...
                        <td className="text-center p-4">
                          <div className="flex">
                            <Link
                              to={`/penguji-sempro/detail/${item.id}`}
