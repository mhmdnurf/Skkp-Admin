        ...
        async (snapshot) => {
          ...
          for (const doc of snapshot.docs) {
            ...
            if (data.penguji[0] === user.uid) {
              setNilaiPenguji(pengajuanInfo.nilaiPengujiSatu);
            } else if (data.penguji[1] === user.uid) {
              setNilaiPenguji(pengajuanInfo.nilaiPengujiDua);
            }
          }
                  ...
                  <tbody className="rounded-b-md text-sm">
                    {data.slice(startIdx, endIdx).map((item, index) => (
                      ...
                      >
                        ...
                        <td className="text-center">{nilaiPenguji}</td>
                        <td className="text-center p-4">
                          <div className="flex">
                            <Link
                              to={`/penguji-kp/detail/${item.id}`}
