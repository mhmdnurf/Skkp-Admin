      ...
      if (userDocSnapshot.exists()) {
        ...
        if (status === "Sah") {
          const response = await fetch(
            `http://localhost:3000/send-notification/hasil-verifikasi-kompre-berhasil/${user_uid}`,
            {
              method: "POST",
              headers: {
          ...
          const response = await fetch(
            `http://localhost:3000/send-notification/hasil-verifikasi-kompre-ditolak/${user_uid}`,
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
