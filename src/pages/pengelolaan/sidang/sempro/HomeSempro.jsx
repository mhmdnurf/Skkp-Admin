...
export const HomeSempro = () => {
  ...
  const handleRiwayatLaporan = () => {
    navigate("/sidang-sempro/riwayat-laporan");
  };
  ...
  const handleLaporan = async () => {
    try {
      ...
      if (querySnapshot.empty) {
        Swal.fire(
          "Gagal",
          "Data Sidang Seminar Proposal tidak ditemukan",
          "error"
        );
      } else {
        const sidangData = [];
        ...
        try {
          ...
          a.href = fileUrl;
          a.download = `Laporan_SeminarProposal_${formattedDate}.xlsx`; // Nama file yang akan diunduh
          ...
          const laporanData = {
            jenisLaporan: "Seminar Proposal",
            createdAt: new Date(),
            fileURL: fileUrl,
            namaLaporan: `Laporan Seminar Proposal - ${formattedDate}`,
          };
