...
export const HomeSidangKP = () => {
  ...
  const handleRiwayatLaporan = () => {
    navigate("/sidang-kp/riwayat-laporan");
  };
  ...
  const handleLaporan = async () => {
    try {
      ...
      if (querySnapshot.empty) {
        Swal.fire(
          "Gagal",
          "Data Sidang Kerja Praktek tidak ditemukan",
          "error"
        );
      } else {
        const sidangData = [];
        ...
        const storageRef = ref(
          storage,
          `laporan/sidangKerjaPraktek/${formattedDate}.xlsx`
        );
        try {
          ...
          const laporanData = {
            ...
            createdAt: new Date(),
            fileURL: fileUrl,
            namaLaporan: `Laporan Sidang KP - ${formattedDate}`,
          };
